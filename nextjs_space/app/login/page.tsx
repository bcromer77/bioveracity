  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <button type="button" onClick={() => signIn('google', { redirectTo: '/account' })} className="w-full flex items-center justify-center gap-3 px-3.5 py-3 rounded-lg border-2 border-input bg-background text-[16px] font-semibold text-foreground hover:bg-muted transition-colors">
