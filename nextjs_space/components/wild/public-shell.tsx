...
export function PublicShell({ children }: { children: ReactNode }) {
  return <div className="bv-public">
    ...
    <header className="bv-header"><Link className="bv-brand" href="/">BioVeracity<span>Evidence & discovery</span></Link>
      <nav aria-label="Main navigation"><Link href="/professionals">For professionals</Link><Link href="/wild">Wild Counties</Link><Link href="/wild/partners">For venues</Link><Link href="/login">Sign in</Link></nav>
    </header>
