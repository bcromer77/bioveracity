              ...
              <section className="bv-form">
                ...
                {plan?.sources.length ? (
                  plan.sources.map((s) => (
                    <p key={s.title}>
                      ...
                      <br />
                      <small>
                        {s.caveat} Publication and event dates are not recorded
                        in this catalogue.
                      </small>
                    </p>
                  ))
                  ...
                  <p>
                    No county source material is attached yet. Your own story
                ...
                {hub.published && (
                  <div className="bv-published">
                    ...
                    />
                    <a href={`/api/wild/qr/${hub.id}?download=1`} download>
                      Download QR
                    </a>
                    <p>
                      <button
