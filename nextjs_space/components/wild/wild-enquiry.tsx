...
export function WildEnquiry() {
  ...
  return <form className="bv-form" onSubmit={submit}>
    ...
    <button className="bv-button bv-green" disabled={busy}>{busy?'Sending your enquiry…':'Contact us for pricing'}</button>
  </form>
}
