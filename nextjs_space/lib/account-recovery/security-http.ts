...
export const identities = () => identityService(securityDb,{
  ...
  send:async(to,token,purpose)=>{
    ...
    const text=purpose==='ADMIN_LOGIN'
      ...
      : `Confirm your BioVeracity email address: ${base}/verify-email#token=${token} . This link expires in one hour. If you did not request it, ignore this email.`
