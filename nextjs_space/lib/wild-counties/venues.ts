...
const VENUES = [
  { id:'example-woodland-venue',county:'down',name:'Your woodland venue',locality:'County Down · Fictional example',heading:'A place to pause. A world to discover.',content:'Imagine your food, people and woodland experience here, told through photographs and words you have approved.' },
  { id:'example-craft-venue',county:'kilkenny',name:'Your craft venue',locality:'Kilkenny · Fictional example',heading:'Start with the making. Discover the place.',content:'Imagine your pottery, designs and visitor experience here, told through photographs and words you have approved.' },
] as const
