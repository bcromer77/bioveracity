...
async function main() {
  ...
  const marchWRC = await prisma.asset.upsert({
    ...
    create: {
      ...
      status: 'monitoring',
      statusDetail: 'Clear case for reconciling human experience with operational evidence. Residents report persistent odour. Anglian Water announced a pause scheduled for 27 July to 22 September 2025; actual cessation and restart remain unconfirmed. No supplied record confirms EA enforcement or planning sanction.',
      latitude: 52.5519,
      longitude: 0.0875,
      ...
      description: 'March WRC is a clear case for reconciling human experience with operational evidence. Residents have reported persistent severe odour, approximately 30–40 lorry or tanker movements per day, road deterioration, vibration and alleged spillages. Anglian Water announced a pause scheduled for 27 July to 22 September 2025; the announcement does not establish actual cessation or restart. No supplied record confirms Environment Agency enforcement or planning sanction against March WRC.',
  ...
  const eventData = [
    ...
    // March WRC
    { assetId: marchWRC.id, title: 'Scheduled start of announced lime-treatment pause', date: new Date('2025-07-27'), eventType: 'operational', evidenceClass: 'O', severity: 'medium', sourceDomain: 'marchtowncouncil.gov.uk', sourceUrl: 'https://www.marchtowncouncil.gov.uk/anglian-water-march-water-recycling-centre-pausing-liming-work-for-the-summer-holidays/', description: 'Operator plan published 9 July 2025; actual cessation and restart are not confirmed by this source.', verified: false },
    { assetId: marchWRC.id, title: 'Scheduled end of announced pause; restart unconfirmed', date: new Date('2025-09-22'), eventType: 'operational', evidenceClass: 'O', severity: 'medium', sourceDomain: 'marchtowncouncil.gov.uk', sourceUrl: 'https://www.marchtowncouncil.gov.uk/anglian-water-march-water-recycling-centre-pausing-liming-work-for-the-summer-holidays/', description: 'Operator plan published 9 July 2025; actual cessation and restart are not confirmed by this source.', verified: false },
